...
SECRET_KEY = 'django-insecure-$li_v*tvjd@2ph-rzr2uvg2wg&av(fj^+e&ad8gdr=fq1gg@en'
...
SIMPLE_JWT = {
    ...
    'ACCESS_TOKEN_LIFETIME': timedelta(minutes=60),  # Set the desired access token lifespan
